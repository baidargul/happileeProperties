      ...
      <div className="position-relative">
        ...
        {userProfileCompleted ? (
          ...
          <div className="bg-white p-30 card-box border-20">
              ...
              {userTypeData.map((item) => (
                <div
                  ...
                  className={`border border-2 mx-3 d-flex align-items-center justify-content-center border-primary flex-column ${
                    userType === item.label ? "bg-primary" : ""
                  }`}
                  style={{
                    width: "100px",
                    height: "100px",
                  ...
                  onClick={() => setUserType(item.label)}
                >
                  <svg
                  ...
                  >
                    <path
                      fill={`${userType === item.label ? "white" : "black"}`}
                      d={item.svg}
                    />
                  </svg>
                  <p
                    className={`fs-14 fw-500 user-select-none mt-2 ${
                      userType === item.label ? "text-white" : ""
                    }`}
                    style={{ margin: 0 }}
                  >
                    {item.label}
            ...
            <div className="d-flex align-items-center justify-content-center">
              <button onClick={()=>setUserProfileCompleted(true)} className="dash-btn-two tran3s me-3 w-25 mt-30 align-self-center">Submit</button>              
            </div>
          </div>
        )}
        {/* <SocialMediaLink />
