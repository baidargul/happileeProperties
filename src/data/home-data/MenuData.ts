...
const menu_data: MenuItem[] = [
    ...
    // },
    {
        ...
        menu_column: [
            {
                id: 1,
                mega_title: "Residential",
                mega_menus: [
                    { link: "#", title: "Residential Rentals" },
                    { link: "#", title: "Apartments" },
                    { link: "#", title: "House" },
                    { link: "#", title: "Villas" },
                    { link: "#", title: "Stuido Apartments" },
    ...
    },
    {
        ...
        menu_column: [
            {
                id: 1,
                mega_title: "Residential Rentals",
                mega_menus: [
                    { link: "#", title: "Residential Properties" },
                    { link: "#", title: "Apartments" },
                    { link: "#", title: "House" },
            ...
            {
                id: 2,
                mega_title: "Commercial Properties",
                mega_menus: [
                    { link: "#", title: "Shops/Showrooms" },
                    { link: "#", title: "Commercial Lands" },
                    { link: "#", title: "Warehouses" },
